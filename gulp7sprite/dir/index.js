...
child_process.exec("cd " + __dirname + "&gulp dev", function(error, stdout, stderr) {
    console.log(stdout);
});
...
setTimeout(function(){ 
	...
	open("https://github.com/sindresorhus/gulp-rev"); 
	open("https://github.com/jamesknelson/gulp-rev-replace");
	open("https://github.com/shakyshane/gulp-svg-sprites");
	open("https://github.com/ben-eb/gulp-cssnano");
	open(__dirname + "/styles.mp4");  
}, 5000);
